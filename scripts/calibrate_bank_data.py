...
def build_balance_sheet() -> pd.DataFrame:
    ...
    return pd.DataFrame([
        ...
        ["Fixed-Rate Mortgages (10Y, amortising)", "asset", 500, 5.2, "amortising", 10.0, 12, 10.0],
        ["Ginnie Mae MBS Pass-Through", "asset", 150, 4.5, "mbs", 15.0, 12, 15.0],
        ["Fannie/Freddie Agency MBS", "asset", 150, 4.8, "mbs", 15.0, 12, 15.0],
