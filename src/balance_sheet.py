...
def get_instruments() -> tuple[list[Instrument], list[Instrument]]:
    ...
    assets = [
        ...
        # ── Long-term ─────────────────────────────────────────────────────────
        Instrument(
            name="Whole-Loan Mortgages 30Y (WAC 5.5)",
            notional=350, coupon_pct=5.50,
            instrument_type="whole_loan",
            maturity_years=30.0,
            payment_freq=12, side="asset",
            age_months=36,
            wac=0.055, wam_months=324, pool_age_months=36,
            anchor_tenor=10.0, spread_to_curve=0.0175, oas=0.005,
            credit_spread=0.0,
        ),
        Instrument(
            name="Whole-Loan Mortgages 15Y (WAC 4.8)",
            notional=200, coupon_pct=4.80,
            instrument_type="whole_loan",
            maturity_years=15.0,
            payment_freq=12, side="asset",
            age_months=48,
            wac=0.048, wam_months=168, pool_age_months=48,
            anchor_tenor=7.0, spread_to_curve=0.015, oas=0.005,
        ),
        Instrument(
            name="Whole-Loan Mortgages 10Y (WAC 5.2)",
            notional=150, coupon_pct=5.20,
            instrument_type="whole_loan",
            maturity_years=10.0,
            payment_freq=12, side="asset",
            age_months=24,
            wac=0.052, wam_months=108, pool_age_months=24,
            anchor_tenor=7.0, spread_to_curve=0.015, oas=0.005,
        ),
        Instrument(
            ...
            age_months=36,
            mbs_level="ginnie",
            wac=0.045, wam_months=300, pool_age_months=36,
            anchor_tenor=10.0, spread_to_curve=0.0175, oas=0.005,
        ),
        Instrument(
            ...
            age_months=36,
            mbs_level="agency",
            wac=0.048, wam_months=300, pool_age_months=36,
            anchor_tenor=10.0, spread_to_curve=0.0175, oas=0.005,
        ),
        Instrument(
            name="Private-Label RMBS (not HQLA)",
            notional=100, coupon_pct=5.80,
            instrument_type="mbs",
            maturity_years=20.0,
            payment_freq=12, side="asset",
            age_months=24,
            mbs_level="private",
            wac=0.058, wam_months=240, pool_age_months=24,
            anchor_tenor=10.0, spread_to_curve=0.020, oas=0.010,
        ),
        Instrument(
            name="Fixed Gov Bonds (15Y)",
            notional=150, coupon_pct=3.50,
            instrument_type="bullet_fixed",
            maturity_years=15.0,
            payment_freq=2, side="asset",
        ),
